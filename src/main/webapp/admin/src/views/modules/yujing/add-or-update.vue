    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预警详情" prop="yujingContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yujingContent" label="预警详情" prop="yujingContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yujingContent: [
                              { required: true, message: '预警详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
